...
<div class="shop-title">
  ...
  <div class="shop-subtitle">
    <a href="/">Home</a><span>></span><a href="/produtos">Comprar</a><span>></span><span class="detalhe">Carrinho de compras</span>
  </div>
</div>
<div class="container">
  <div class="row">
...
<form id="formDestino" action="">
    ...
    <hr>
    <div class="row">
      <button class="button-direct-home"><a href="{{route('home')}}">Continuar comprando</a></button>
